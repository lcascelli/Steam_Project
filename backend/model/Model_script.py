...
steamspy_df = pd.read_csv("backend/data/static/steamspy_all_games.csv")
storefront_df_raw = pd.read_csv('backend/data/static/storefront_data.csv')
...
#checking expected columns against actual columns, for debugging
...
joblib.dump(pipe_binned, 'backend/model/rf_model.joblib')
